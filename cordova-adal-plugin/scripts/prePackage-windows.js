...
module.exports = function (ctx) {
    ...
    var helperPluginId = 'cordova-adal-plugin-sso';
    ...
    var pluginXml = shell.ls(path.join(ctx.opts.projectRoot, 'plugins/cordova-adal-plugin/plugin.xml'))[0];
    ...
    var ssoPluginPath = path.join(ctx.opts.projectRoot, 'plugins/cordova-adal-plugin/src/windows/sso');
